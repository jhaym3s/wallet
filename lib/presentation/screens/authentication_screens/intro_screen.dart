      ...
      body: SafeArea(
        ...
        child: Center(
          child: Column(
            ...
            children:  [
              const Text("Wallet Setup"),
              const Text("Import an existing wallet or create a new one"),
              const Gap(20),
              IntroScreenButton(
                  text: "A new wallet will be created to hold assets",
                  title: "Create Wallet",
                  onPressed: () => Navigator.pushNamed(context, CreateWallet.routeName),
                  color: const Color(0xff248FF2)),
              IntroScreenButton(
                  text: "Import your wallet with your 12 word key phrase",
                  onPressed: () => Navigator.of(context).pushNamed(ImportWallet.routeName),
                  title: "Import Wallet",
